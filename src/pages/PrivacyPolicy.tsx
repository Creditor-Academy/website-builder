        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          ...
          >
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              ...
              We value your trust. This policy explains how Web Studio handles your data with the highest standards of security.
            </p>
          </motion.div>
        </div>
      </div>
        ...
        <section className="space-y-20">
          <div id="who-we-are" className="scroll-mt-32 group">
            ...
            <div className="prose prose-slate prose-lg max-w-none text-slate-600">
              <p>
                Web Studio provides high-end residential and commercial
