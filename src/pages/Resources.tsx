...
const Resources = () => {
  ...
  const mainResources = [
    ...
    },
    {
      ...
      description: "Explore designs by other Web Studio users."
    },
    {
  ...
  return (
    <main className={cn(
      ...
      <Helmet>
        ...
        <meta name="description" content="Explore Web Studio's collection of resources, tools, and guides to help you build better websites." />
      </Helmet>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto text-center mb-20">
          ...
          <p className={cn("text-xl md:text-2xl max-w-2xl mx-auto font-medium", isDark ? "text-slate-400" : "text-slate-600")}>
            Access thousands of professionally curated assets directly within the Web Studio editor.
          </p>
        </div>
      ...
      <section className="py-20 px-6 text-center relative overflow-hidden">
        ...
        >
          ...
          <p className={cn("text-xl mb-12 relative z-10 leading-relaxed max-w-2xl mx-auto font-medium", isDark ? "text-slate-300" : "text-slate-600")}>
            Join 50k+ creators using Web Studio's resources to launch their professional businesses today.
          </p>
