        ...
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          >
            ...
            <p className="text-xl text-slate-600 leading-relaxed">
              By using the Webstudio platform, you are agreeing to the following terms. Please read them carefully to understand your rights and obligations.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <section className="space-y-24">
          ...
          <div id="acceptance" className="scroll-mt-32">
            ...
            <p className="text-slate-600 text-lg leading-relaxed pl-16">
              By accessing Webstudio, you confirm that you are at least 18 years old and agree to be bound by these Terms of Service. If you are using the services on behalf of an organization, you represent that you have the authority to bind that entity to these terms.
            </p>
          </div>
          ...
          <div id="usage" className="scroll-mt-32">
            ...
            <div className="pl-16 space-y-4">
              <p className="text-slate-600 text-lg leading-relaxed">
                You may use Webstudio only for lawful purposes. You agree not to:
              </p>
          ...
          <div id="intellectual-property" className="scroll-mt-32 border-l-4 border-indigo-600 pl-8 ml-6">
            ...
            <p className="text-slate-600 text-lg leading-relaxed">
              All content, templates, designs, and software provided by Webstudio are owned by or licensed to us. You are granted a limited, non-exclusive license to use the templates for your personal or business website, but copying the "Webstudio Engine" or reselling our core assets is strictly prohibited.
            </p>
          </div>
          ...
          <div id="payments" className="scroll-mt-32">
            ...
            <div className="pl-16 p-8 bg-indigo-900 rounded-[2.5rem] text-white shadow-xl shadow-indigo-100 relative overflow-hidden">
               ...
               <p className="leading-relaxed mb-4 text-indigo-100">
                 Paid plans are billed according to the pricing displayed at purchase. Webstudio reserves the right to change pricing with 30-day prior notice. 
               </p>
          ...
          <div id="liability" className="scroll-mt-32 border-t border-slate-200 pt-16">
             ...
             <p className="text-slate-500 text-lg leading-relaxed pl-16 italic">
               Webstudio is provided "as is". We shall not be liable for any indirect, incidental, or consequential damages resulting from your use of the platform.
             </p>
          </div>
