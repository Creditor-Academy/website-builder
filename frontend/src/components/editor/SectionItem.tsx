...
import { GripVertical, Eye, EyeOff, Copy, Trash2, Layout, Sparkles, Grid3X3, Image, MessageSquare, BarChart2, Users, HelpCircle, Building2, DollarSign, Mail, Quote, MoreVertical, Info, FileText } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuTrigger, DropdownMenuSeparator } from '@/components/ui/dropdown-menu';

const sectionIcons = { hero: Sparkles, features: Grid3X3, services: Layout, cta: MessageSquare, testimonials: Quote, gallery: Image, pricing: DollarSign, contact: Mail, stats: BarChart2, team: Users, faq: HelpCircle, logocloud: Building2, custom: Layout, about: Info, blog: FileText };
const sectionColors = { hero: 'from-blue-500 to-blue-600', features: 'from-purple-500 to-purple-600', services: 'from-green-500 to-green-600', cta: 'from-amber-500 to-amber-600', testimonials: 'from-pink-500 to-pink-600', gallery: 'from-cyan-500 to-cyan-600', pricing: 'from-indigo-500 to-indigo-600', contact: 'from-rose-500 to-rose-600', stats: 'from-teal-500 to-teal-600', team: 'from-orange-500 to-orange-600', faq: 'from-violet-500 to-violet-600', logocloud: 'from-slate-500 to-slate-600', custom: 'from-gray-500 to-gray-600', about: 'from-emerald-500 to-emerald-600', blog: 'from-blue-600 to-blue-700' };
